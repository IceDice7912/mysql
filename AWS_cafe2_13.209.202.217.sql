...
--insert into member(id, pw, name) values('a', 'a', '이상묵'); 
--insert into member(id, pw, name) values('b', 'b', 'IceDice');
--insert into board(PARENTNO, TITLE, CONTENT, ID) values('0', '테스트1', '되나요?', 'a');
--insert into board(PARENTNO, TITLE, CONTENT, ID) values('1', '됩니다', '^^', 'b');
